	...
	$.fn.carousel = function(param){
		...
		$.extend({switchImg:function(){
			...
			$(".carousel-prev").hover(function(){
				$(this).find("img").attr("src","/images/banner/left_btn2.png");
			},function(){
				$(this).find("img").attr("src","/images/banner/left_btn1.png");
			});
			$(".carousel-next").hover(function(){
				$(this).find("img").attr("src","/images/banner/right_btn2.png");
			},function(){
				$(this).find("img").attr("src","/images/banner/right_btn1.png");
			});
